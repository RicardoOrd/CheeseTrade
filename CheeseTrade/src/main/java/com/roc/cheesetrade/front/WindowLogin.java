...
import com.roc.cheesetrade.entities.UsuarioSesion;
...
public class WindowLogin extends javax.swing.JFrame {
    ...
    private void validarLogin() {
        ...
        UsuarioSesion sesion = LoginValidator.autenticarUsuario(usuario, password);
        if (sesion != null) {
            JOptionPane.showMessageDialog(this, "¡Inicio de sesión exitoso!");
            Home ventanaMenu = new Home(sesion.getUsuario(), sesion.getRol()); // <-- Ahora le pasas la sesión completa
