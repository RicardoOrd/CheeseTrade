        ...
        for (Usuario u : lista) {
            ...
            btnEliminar.addActionListener(e -> {
                ...
                if (confirm == javax.swing.JOptionPane.YES_OPTION) {
                    boolean exito = dao.eliminar(u.getId());
                    if (exito) {
            ...
            btnEditar.addActionListener(e -> {
                EditarUsuarioDialog dialog = new EditarUsuarioDialog(this, true, u); // (this, true, usuario)
                dialog.setVisible(true);
                cargarUsuarios(); // Refresca la lista al cerrar
            });
